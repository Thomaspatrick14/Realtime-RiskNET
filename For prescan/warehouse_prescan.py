        ...
        while True:
            ...
            while True:
                ...
                if len(frame_data) == frame_size:
                    ...
                    self.frame = np.stack((b, g, r), axis=-1)
                    break       
            ...
            if fps_flag:
                ...
                if masks.shape[2] == 8:
                    ...
                    ogframe = self.frame.copy()
                    ogframe = cv2.putText(ogframe, f"Prediction: {predictions[0]}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
                    combined_frame = np.hstack((np.vstack((ogframe, frame_with_processed_boxes)),np.vstack((frame_with_dboxes, dmask))))
